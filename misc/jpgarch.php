...
$g = new CanvasGraph(700,450,'auto');
//$g->SetMargin(2,3,2,3);
...
$l = 2;		// Left margin
$r = 14;	// Row number to start the lowest line on
...
$t->Set("PHP Client of JpGraph",$l,$r,$width,$h); $t->Stroke($g->img,$scale);

// Stroke title
$r = 0.5;
$tt->SetFontColor('black');
$tt->SetFont(FF_ARIAL,FS_BOLD,18);
